  ...
  <div class="play">
    ...
    <div class="content">
      ...
      <img
        ...
        :src="
          audio.musicImgSrc ||
          (musicData[0] && musicData[0].musicImgSrc) ||
          defaultImg
        "
        alt="microzz.com"
      />
      ...
      <div class="skin">
        <transition name="slide-fade">
          <div v-show="isShowSkinColors" class="skin-colors">
            <i
              @click="changeSkinColor('#B72712')"
              :class="{ selected: skinColor === '#B72712' }"
              class="one"
            ></i>
            <i
              @click="changeSkinColor('#1565C0')"
              :class="{ selected: skinColor === '#1565C0' }"
              class="two"
            ></i>
            <i
              @click="changeSkinColor('#212121')"
              :class="{ selected: skinColor === '#212121' }"
              class="three"
            ></i>
            <i
              @click="changeSkinColor('#1B5E20')"
              :class="{ selected: skinColor === '#1B5E20' }"
              class="four"
            ></i>
          </div>
        </transition>
        ...
        <div
          @click="showSkinColor"
          :class="{
            'icon-skin-red': skinColor === '#B72712',
            'icon-skin-blue': skinColor === '#1565C0',
            'icon-skin-black': skinColor === '#212121',
            'icon-skin-green': skinColor === '#1B5E20',
          }"
          class="icon-skin"
        ></div>
      </div>
...
export default class Play extends Vue {
  ...
  private isShowSkinColors: any = false;
  private isShowMusicList: any = false;

  private skinColorWatch(val: any): void {
  ...
  private prev(): void {
    // this.audio.index =
    //   this.audio.index === 0 ? this.musicData.length - 1 : --this.audio.index;
  ...
  private showSkinColor(): void {
    this.isShowSkinColors = !this.isShowSkinColors;
  }
  private changeSkinColor(color: any): void {
